...
#define SMEXT_CONF_NAME			"Zombie Mod Extension"
#define SMEXT_CONF_DESCRIPTION	"[CS:GO] Game modification"
#define SMEXT_CONF_VERSION		"2.0"
#define SMEXT_CONF_AUTHOR		"Copyright (C) 2015-2018 Nikita Ushakov (Ireland, Dublin)"
