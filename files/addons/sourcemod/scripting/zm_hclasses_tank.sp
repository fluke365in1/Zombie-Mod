...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_tank_name", 		"Tank");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_tank_model",	 	"models/player/tm_leet_variantb.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_tank_arm", 		"models/weapons/t_arms_leet.mdl");
	gCvarList[CVAR_HUMAN_CLASS_HEALTH] 		= CreateConVar("zm_tank_health", 	"100");
	gCvarList[CVAR_HUMAN_CLASS_SPEED]		= CreateConVar("zm_tank_speed", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_GRAVITY] 	= CreateConVar("zm_tank_gravity", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_ARMOR] 		= CreateConVar("zm_tank_armor", 	"0");
	gCvarList[CVAR_HUMANE_CLASS_FEMALE] 	= CreateConVar("zm_tank_female", 	"0");

	// Create config
	AutoExecConfig(true, "zm_human_tank");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanTank = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
