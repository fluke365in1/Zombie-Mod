 ...
 *
 *
 *  Copyright (C) 2017-2018-2018 Nikita Ushakov (Ireland, Dublin)
 *
...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_balkan_name", 		"Balkan");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_balkan_model",	 	"models/player/tm_balkan_variantc.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_balkan_arm", 		"models/weapons/t_arms_balkan.mdl");
	gCvarList[CVAR_HUMAN_CLASS_HEALTH] 		= CreateConVar("zm_balkan_health", 		"100");
	gCvarList[CVAR_HUMAN_CLASS_SPEED]		= CreateConVar("zm_balkan_speed", 		"1.0");
	gCvarList[CVAR_HUMAN_CLASS_GRAVITY] 	= CreateConVar("zm_balkan_gravity", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_ARMOR] 		= CreateConVar("zm_balkan_armor", 		"0");
	gCvarList[CVAR_HUMANE_CLASS_FEMALE] 	= CreateConVar("zm_balkan_female", 		"0");

	// Create config
	AutoExecConfig(true, "zm_human_balkan");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanBalkan = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
