...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_ct_name", 		"CT");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_ct_model",	 	"models/player/ctm_sas_variantb.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_ct_arm", 		"models/weapons/ct_arms_sas.mdl");
	gCvarList[CVAR_HUMAN_CLASS_HEALTH] 		= CreateConVar("zm_ct_health", 		"100");
	gCvarList[CVAR_HUMAN_CLASS_SPEED]		= CreateConVar("zm_ct_speed", 		"1.0");
	gCvarList[CVAR_HUMAN_CLASS_GRAVITY] 	= CreateConVar("zm_ct_gravity", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_ARMOR] 		= CreateConVar("zm_ct_armor", 		"0");
	gCvarList[CVAR_HUMANE_CLASS_FEMALE] 	= CreateConVar("zm_ct_female", 		"0");

	// Create config
	AutoExecConfig(true, "zm_human_ct");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanCT = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
