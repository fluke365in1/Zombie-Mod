...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_sas_name", 		"SAS");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_sas_model",	 	"models/player/tm_professional_var2.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_sas_arm", 		"models/weapons/t_arms_professional.mdl");
	gCvarList[CVAR_HUMAN_CLASS_HEALTH] 		= CreateConVar("zm_sas_health", 	"100");
	gCvarList[CVAR_HUMAN_CLASS_SPEED]		= CreateConVar("zm_sas_speed", 		"1.0");
	gCvarList[CVAR_HUMAN_CLASS_GRAVITY] 	= CreateConVar("zm_sas_gravity", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_ARMOR] 		= CreateConVar("zm_sas_armor", 		"0");
	gCvarList[CVAR_HUMANE_CLASS_FEMALE] 	= CreateConVar("zm_sas_female", 	"0");

	// Create config
	AutoExecConfig(true, "zm_human_sas");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanSAS = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
