...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_anarhist_name", 		"Anarhist");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_anarhist_model",	 	"models/player/tm_anarchist_variantd.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_anarhist_arm", 		"models/weapons/t_arms_anarchist.mdl");
	...
	// Create config
	AutoExecConfig(true, "zm_human_anarhist");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanAnarhist = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
