...
{
	// Load cvars
	gCvarList[CVAR_HUMAN_CLASS_NAME] 		= CreateConVar("zm_strong_name", 		"Strong");
	gCvarList[CVAR_HUMAN_CLASS_MODEL] 		= CreateConVar("zm_strong_model",	 	"models/player/tm_separatist_variantd.mdl");
	gCvarList[CVAR_HUMAN_CLASS_ARM] 		= CreateConVar("zm_strong_arm", 		"models/weapons/t_arms_separatist.mdl");
	gCvarList[CVAR_HUMAN_CLASS_HEALTH] 		= CreateConVar("zm_strong_health", 		"100");
	gCvarList[CVAR_HUMAN_CLASS_SPEED]		= CreateConVar("zm_strong_speed", 		"1.0");
	gCvarList[CVAR_HUMAN_CLASS_GRAVITY] 	= CreateConVar("zm_strong_gravity", 	"1.0");
	gCvarList[CVAR_HUMAN_CLASS_ARMOR] 		= CreateConVar("zm_strong_armor", 		"0");
	gCvarList[CVAR_HUMANE_CLASS_FEMALE] 	= CreateConVar("zm_strong_female", 		"0");

	// Create config
	AutoExecConfig(true, "zm_human_strong");
}
...
public void OnMapStart(/*void*/)
{
	...
	gHumanStrong = ZM_RegisterHumanClass(sHumanName, 
	sHumanModel[0], 
	sHumanModel[1], 
